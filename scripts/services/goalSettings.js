...
const DEFAULT_GOAL_API_BASE = `${window.API_BASE_URL || 'https://uqg1gdotaa.execute-api.ap-northeast-1.amazonaws.com/dev'}/goal`;
const KPI_TARGET_API_BASE = window.API_BASE_URL || 'https://uqg1gdotaa.execute-api.ap-northeast-1.amazonaws.com/dev'; // New API Base
